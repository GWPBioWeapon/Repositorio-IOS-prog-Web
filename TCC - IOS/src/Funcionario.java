public class Funcionario {
    ...
    Funcionario(String nome, String area, String tel, String diaSem) {
        this.nomeProf = nome;
        this.areaProf = area;
        this.telWP = tel;
        this.diaDisp = diaSem;
    ...
    public String dadosString() {
        ...
        String atr2 = "Area de atuacao: " + this.areaProf;
        String atr3 = "Telefone: " + this.telWP;
        String atr4 = "Dias da Semana disponivel: " + this.diaDisp;
        return "\n" + atr1 + "\n" + atr2 + "\n" + atr3 + "\n" + atr4 + "\n";
    }
